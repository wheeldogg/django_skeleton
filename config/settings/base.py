"""
Base settings for Django Skeleton project.
"""
...
# Determine if we should use SQLite (simpler for local development)
USE_SQLITE = config('DB_ENGINE', default='').endswith('sqlite3') or \
